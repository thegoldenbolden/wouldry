...
export type Icon = typeof BaseIcon;
...
export const logos: Record<Provider, typeof BaseIcon> = {
  discord: Discord,
  google: Google,
  twitch: Twitch,
};

/** Brand Logos: https://boxicons.com */
export function Discord(props: IconProps) {
  return (
    <BaseIcon aria-label="discord logo" {...props}>
...
export function Twitch(props: IconProps) {
  return (
    <BaseIcon aria-label="twitch logo" {...props}>
...
export function Google(props: IconProps) {
  return (
    <BaseIcon aria-label="google logo" {...props}>
      <path d="M20.283 10.356h-8.327v3.451h4.792c-.446 2.193-2.313 3.453-4.792 3.453a5.27 5.27 0 0 1-5.279-5.28 5.27 5.27 0 0 1 5.279-5.279c1.259 0 2.397.447 3.29 1.178l2.6-2.599c-1.584-1.381-3.615-2.233-5.89-2.233a8.908 8.908 0 0 0-8.934 8.934 8.907 8.907 0 0 0 8.934 8.934c4.467 0 8.529-3.249 8.529-8.934 0-.528-.081-1.097-.202-1.625z" />
    </BaseIcon>
  );
}

//#region Icons that toogle between outline and solid
export function Home(props: IconProps) {
  return (
    <BaseIcon aria-label="home icon" {...props}>
      {/** Solid */}
      <path
      ...
      {/** Outline */}
      <path
        className="group-data-[active=true]:hidden"
...
export function Pencil(props: IconProps) {
  return (
    <BaseIcon aria-label="pencil icon" {...props}>
      {/** Solid */}
      <path
        className="group-data-[active=false]:hidden"
...
export function Search(props: IconProps) {
  return (
    <BaseIcon aria-label="search icon" {...props}>
      ...
      <path
        className="group-data-[active=false]:hidden"
        d="M10 2c-4.411 0-8 3.589-8 8s3.589 8 8 8a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8z"
      />
      {/** Outline */}
      <path
        className="group-data-[active=true]:hidden"
...
export function User(props: IconProps) {
  return (
    <BaseIcon aria-label="user icon" {...props}>
      {/** Solid */}
      <path
        className="group-data-[active=false]:hidden"
...
export function Login(props: IconProps) {
  return (
    <BaseIcon aria-label="login icon" {...props}>
      {/** Solid */}
      <path
        className="group-data-[active=false]:hidden"
...
export function Lock(props: IconProps) {
  return (
    <BaseIcon aria-label="lock icon" {...props}>
      {/** Solid */}
      <path
        className="group-data-[active=true]:hidden"
...
export function BlankFile(props: IconProps) {
  return (
    <BaseIcon aria-label="lock icon" {...props}>
      {/** Solid */}
      <path
...
export function Cookie(props: IconProps) {
  return (
    <BaseIcon aria-label="cookie icon" {...props}>
      {/** Solid */}
      <path
        className="group-data-[active=true]:hidden"
...
export function Collection(props: IconProps) {
  return (
    <BaseIcon aria-label="collection icon" {...props}>
...
export function PowerOff(props: IconProps) {
  return (
    <BaseIcon aria-label="power off icon" {...props}>
...
export function Chat(props: IconProps) {
  return (
    <BaseIcon aria-label="chat icon" {...props}>
...
export function Edit(props: IconProps) {
  return (
    <BaseIcon aria-label="edit icon" {...props}>
      <path d="M5 18v3.766l1.515-.909L11.277 18H16c1.103 0 2-.897 2-2V8c0-1.103-.897-2-2-2H4c-1.103 0-2 .897-2 2v8c0 1.103.897 2 2 2h1zM4 8h12v8h-5.277L7 18.234V16H4V8z" />
      <path d="M20 2H8c-1.103 0-2 .897-2 2h12c1.103 0 2 .897 2 2v8c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2z" />
    </BaseIcon>
  );
...
export function ChevronLeft(props: IconProps) {
  return (
    <BaseIcon aria-label="left arrow icon" {...props}>
...
export function Toggle(props: IconProps) {
  return (
    <BaseIcon aria-label="toggle icon" {...props}>
      {/** off */}
      <path
...
export function Dots(props: IconProps) {
  return (
    <BaseIcon aria-label="ellipsis icon" {...props}>
...
export function Send(props: IconProps) {
  return (
    <BaseIcon aria-label="send icon" {...props}>
...
export function Cog(props: IconProps) {
  return (
    <BaseIcon aria-label="cog icon" {...props}>
...
export function Plus(props: IconProps) {
  return (
    <BaseIcon aria-label="plus icon" {...props}>
...
export function Trash(props: IconProps) {
  return (
    <BaseIcon aria-label="trash icon" {...props}>
...
export function Trophy(props: IconProps) {
  return (
    <BaseIcon aria-label="trophy icon" {...props}>
...
export function Reply(props: IconProps) {
  return (
    <BaseIcon aria-label="reply icon" {...props}>
...
export function Flag(props: IconProps) {
  return (
    <BaseIcon aria-label="flag icon" {...props}>
...
export function Circle(props: IconProps) {
  return (
    <BaseIcon aria-label="circle icon" {...props}>
...
export function InfoCircle(props: IconProps) {
  return (
    <BaseIcon aria-label="info icon" {...props}>
      <path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z" />
...
export function ColorFill(props: IconProps) {
  return (
    <BaseIcon aria-label="paint bucket icon" {...props}>
